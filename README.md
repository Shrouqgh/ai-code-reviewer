...
Built as part of the **Careem Forward Deployment Engineer AI Challenge**.
...
Supports: Python, JavaScript, TypeScript, Go, SQL, and Other.
...
```
index.html   — the entire app (HTML + CSS + JS, single file, no build step)
README.md    — this file
```
...
- [Anthropic Claude API](https://www.anthropic.com) — `claude-sonnet-4`
